...
import com.ngstudio.organaizer.OrganaizersApplication;
import com.ngstudio.organaizer.R;
import com.ngstudio.organaizer.ui.dialogs.AlertDialogBase;
import com.ngstudio.organaizer.ui.fragments.BaseFragment;
...
public abstract class BaseActivity extends ActionBarActivity {
    ...
    private class ProgressDialog extends AlertDialogBase {
        ...
        public void setText(final CharSequence text) {
            /*Temporary empty method, in future decomment original
             *setText method, each declared following */
        }
...
//		}
    ...
    protected void onResume() {
        ...
        OrganaizersApplication.getInstance().activityResumed(((Object) this).getClass().getSimpleName());
    }

    @Override
    protected void onPause() {
        OrganaizersApplication.getInstance().activityPaused(((Object) this).getClass().getSimpleName());
